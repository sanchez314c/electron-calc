...
1. Check the [Issues](https://github.com/your-username/electron-calculator/issues) tab
2. Look for issues labeled `good first issue` or `help wanted`
3. Check the [TODO.md](TODO.md) file for planned features
4. Review the [LEARNINGS.md](LEARNINGS.md) for known areas for improvement
